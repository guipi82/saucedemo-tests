...
/**
 * DriverFactory is a utility class that provides methods to initialize and manage WebDriver instances.
 */

public class DriverFactory {
    private static ThreadLocal<WebDriver> driver = new ThreadLocal<>();// ThreadLocal to ensure each thread has its own WebDriver instance
    ...
    if (driver.get() == null) {
        switch (browser.toLowerCase()) {
            case "chrome":
                ...
                options.addArguments("--incognito"); // << Inkognito-Modus aktiviert
